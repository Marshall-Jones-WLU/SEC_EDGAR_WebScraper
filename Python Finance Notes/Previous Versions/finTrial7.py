...
TODO:
Get rid of excel output for now
Combine analysis csv documents into 1
...
def analysis(balSheet_df, income_df, cashFlow_df, companyInfoDict, dirPath, filingDate, ticker):
    ...
    ebit2 = None
    ebit3 = None
    ebitKeys = ["Income from operations","Operating income","Operating Income","Earnings from operations",
    ...
    income2 = None
    income3 = None
    incomeKeys = ["Net income","Net Income","Net earnings"]
...
def main():
    ...
    print("\n\n")
    cashFlow_df = make_cashFlow_df(statements_data, reportOrder)
    print("\n\n")
    #equity_df = make_equity_df(statements_data, reportOrder)
    print("\n\n")
